...
(function(global)
{
			...
			function parseNextFile()
			{
				...
				if (isFunction(options.before))
				{
					...
					if (typeof returned === 'object')
					{
						...
						{
							fileComplete(f.file);	// parse the next file in the queue, if any
							return;
						}
				...
				//if the user has an options.complete unction, then execute it
				if (options.complete) options.complete(f.file);       //***********************added here ssa
	...
	function FileStreamer(config)
	{
		...
		{
			this._handle.fileBeingParsed(file);           //*******************************code added ssa
			this._input = file;
	...
	function ParserHandle(_config)
	{
		...
		var self = this;
		this.fileBeingParsed = null;   //****************************************************code added ssa
		...
		this.fileBeingParsed = function(file){    //**************************************************function added ssa
			this.fileBeingParsed = file;
		}
			...
			_config.step = function(results)
			{
				...
				else	// only call user's step function after header row
				{
					...
					if (_config.preview && _stepCounter > _config.preview)
						...
						userStep(_results, _fileBeingParsed, self);   //************************************code changed ssa
				}
			};
		}
